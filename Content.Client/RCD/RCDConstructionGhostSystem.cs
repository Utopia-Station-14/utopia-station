...
public sealed partial class RCDConstructionGhostSystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        if (heldEntity == placerEntity && prototype == placerProto && // Utopia-Tweak : RPD
            _placementManager.CurrentPermission?.PlacementOption == desiredMode) // Utopia-Tweak : RPD
            return;
        ...
        var newObjInfo = new PlacementInformation
        {
            ...
            PlacementOption = desiredMode, // Utopia-Tweak : RPD
            EntityType = prototype, // Utopia-Tweak : RPD
            Range = (int)Math.Ceiling(SharedInteractionSystem.InteractionRange),
            IsTile = (cachedProto.Mode == RcdMode.ConstructTile), // Utopia-Tweak : RPD
