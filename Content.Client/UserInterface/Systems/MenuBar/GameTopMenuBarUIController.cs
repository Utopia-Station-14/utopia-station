...
public sealed class GameTopMenuBarUIController : UIController
{
    ...
    [Dependency] private readonly LanguageMenuUIController _language = default!; // Utopia-Tweak : Language
    ...
    public void UnloadButtons()
    {
        ...
        _language.UnloadButton(); // Utopia-Tweak : Language
    }
    ...
    public void LoadButtons()
    {
        ...
        _sandbox.LoadButton();
        _emotes.LoadButton();
        _language.LoadButton(); // Utopia-Tweak : Language
    }
}
