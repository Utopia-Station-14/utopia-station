...
public sealed partial class GeneticistsConsoleStorageView : Control
{
    ...
    public void RefreshResearchLabel()
    {
        ...
        {
            StorageInfoResearchLabel.Text = null;
            return;
        }
    ...
    private void UpdateActionButtonsState()
    {
        ...
        DeleteMutationButton.Disabled = false;

        var showResearch = false;
        var researchText = Loc.GetString("dna-scanner-research-mutation");
    ...
    private void UpdateResearchCountLabel()
    {
        ...
        var current = ParentWindow.ActiveResearchIds.Count;
    ...
    {
        StorageInfoNameLabel.Text = null;
        StorageInfoDescLabel.Text = null;
        StorageInfoInstabilityLabel.Text = null;
        StorageInfoResearchLabel.Text = null;
        StorageConflictsLabelContainer.Visible = false;
    }
}
