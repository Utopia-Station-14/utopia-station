...
namespace Content.Shared_Utopia.Effects;
...
public sealed partial class SparksSystem : EntitySystem
{
    ...
    public void DoSparks(EntityCoordinates coords, int minSparks = 1, int maxSparks = 3, float minVelocity = 1f, float maxVelocity = 4f, bool playSound = true)
    {
        if (_net.IsClient)
            return;
