...
public sealed partial class TelephoneSystem : SharedTelephoneSystem
{
    ...
    private void OnTelephoneMessageReceived(Entity<TelephoneComponent> entity, ref TelephoneMessageReceivedEvent args)
    {
        ...
        _chat.TrySendInGameICMessage(speaker, args.Message, volume, range, nameOverride: name, checkRadioPrefix: false, language: args.Language); // Utopia-Tweak : Language
    }
    ...
    private void SendTelephoneMessage(EntityUid messageSource, string message, Entity<TelephoneComponent> source, bool escapeMarkup = true, LanguagePrototype? language = null) // Utopia-Tweak : Language
    {
        ...
        var evReceivedMessage = new TelephoneMessageReceivedEvent(message, chatMsg, messageSource, source, language); // Utopia-Tweak : Language
