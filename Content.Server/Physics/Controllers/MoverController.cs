...
public sealed class MoverController : SharedMoverController
{
    ...
    private Vector2 ObtainMaxVel(Vector2 vel, ShuttleComponent shuttle)
    {
        ...
        var horizComp = vel.X != 0 ? MathF.Pow(Vector2.Dot(vel, new(shuttle.BaseLinearThrust[horizIndex] / shuttle.LinearThrust[horizIndex], 0f)), 2) : 0; // Utopia-Tweak : Machine Parts
        var vertComp = vel.Y != 0 ? MathF.Pow(Vector2.Dot(vel, new(0f, shuttle.BaseLinearThrust[vertIndex] / shuttle.LinearThrust[vertIndex])), 2) : 0; // Utopia-Tweak : Machine Parts
