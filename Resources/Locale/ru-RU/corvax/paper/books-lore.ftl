book-expensive-crystal-contents =
    ...
    Истинный потенциал Блюспейс кристалла проявляется в его связанной работой с твёрдым фороном. Форон при распаде выделяет колоссальное количество энергии, которую способен поглотить и сохранить космеций. Далее он сможет постепенно отдавать эту энергию в специальные устройства. Но истинной уникальностью является то, что блюспейс кристалл способен стать основой для мощного квантового осциллятора, способного взаимодействовать напрямую с волнами вероятности де Бройля.
...
book-grav-contents =
    ...
    Генератор же гравитации представляет собой невероятное сочетание уникальной по своей природе форона с антиматерией. При облучении форона антигелием формируется не обычная фотонная вспышка, а вспышка гравитационного антиполя (оно же «поле искусственной гравитации»). Все тела, попадающие в действие антиполя начинают воспроизводить гравитационное искажение, не меняя свою стандартную массу, а формируя мнимую гравитационную массу. Таким образом у всего в поле действия генератора гравитации увеличивается ньютоновское притяжение друг к другу, не используя центробежное вращение, как в космических кораблях тысячелетней давности.
...
book-gefest-contents =
    ...
    После открытия форона, корпорация начала искать способы обнаружения ее в космосе. Как оказалось, планеты, в атмосфере которых, находилось приличное количество форона можно было обнаружить путем наблюдения — из-за особых физических свойств форона, даже незначительного звездного света хватало, чтобы атмосфера светилась фиолетовым цветом.

    Несколько веков бизнес Гефеста развивался в соответствии со всем миром, однако форона, впрочем, как и нефти было недостаточно, относительно масштабов ОПЗ. И если нефтяные месторождения можно найти на планетах с жизнью, то с фороном дела обстояли сложнее. Руководство корпорации стремилось решить проблему форонового и нефтяного голода.

    С помощью запатентованного метода специального радиоэлектронного анализа, разработанного профессором Рулевым, удалось узнать, что на краю галактики форона оказалось на несколько порядков больше, чем в изученной галактике.

    Экономика ОПЗ требовала всё больше и больше форона, и с течением времени идеи о колонизации фронтира не казались такими дорогими как это могло показаться на первый взгляд. Череда удачных событий привела Гефест на фронтир. Вслед за Гефестом проследовали и другие корпорации.

    Как оказалось, на фронтире есть не только форон, но множество артефактов, оставленные некогда великой цивилизацией, изучением которых занимаются другие корпорации.
