...
tips-dataset-38 = Будучи предателем, форон в газообразном виде — отличный способ навести хаос. Его можно поджечь, чтобы сделать область непригодной для жизни, форон также может отравлять токсинами тех, кто его вдыхает.
tips-dataset-39 = Будучи предателем, обезвоженные карпы полезны для убийства большого количества людей.
tips-dataset-40 = Будучи предателем, вы пробовали вводить форон в батареи? В случае с дефибриллятором он взрывается при использовании, нанося вред пациенту!
...
tips-dataset-74 = Будучи инженером, вы можете использовать фороновое стекло для укрепления местности и защиты от радиации. Урановое стекло может быть тоже использовано для защиты от радиации.
...
tips-dataset-94 = Пожарные костюмы, зимние куртки и аварийные скафандры обеспечивают умеренную защиту от холода, позволяя вам проводить в космосе и в разгерметизированных отсеках больше времени, чем если бы на вас не было ничего.
tips-dataset-95 = В экстренной ситуации не забывайте, что пожарные и аварийные скафандры всегда находятся в соответствующих шкафчиках. В них может быть неудобно передвигаться, но они могут легко спасти вам жизнь в плохой ситуации!
...
tips-dataset-98 = Вы можете создать копья с осколков бронированного, форонового и уранового стекла для увеличения урона.
