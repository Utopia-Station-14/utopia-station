...
tips-dataset-38 = Будучи предателем, форон в газообразном виде — отличный способ навести хаос. Её можно поджечь, чтобы сделать область непригодной для жизни, форон также может отравлять токсинами тех, кто её вдыхает.
