...
salv-job-board-name-BountySalvageOrePlasma = Форон (Руда)
...
bounty-description-salvage-ore-plasma = Нам нужна партия фороновой руды для отправки на исследовательскую станцию. Пожалуйста, предоставьте нам её, чтобы мы могли продолжить наши испытания. Она может быть любого происхождения.
