...
ent-CrateEngineeringSingularityCollector = ящик с коллектором радиации
    .desc = Коллектор для радиации, используемый в сингулярном двигателе. Форон входит в комплект.
...
ent-CrateEngineeringTeslaCoil = ящик с трансформатором Теслы
    .desc = Трансформатор Теслы. Притягивает молнии и вырабатывает из них энергию.
